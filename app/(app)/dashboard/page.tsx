      ...
      <div className="flex gap-4 py-4 border-b border-white/[0.05] active:bg-white/[0.02] transition-colors">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[9px] font-sans uppercase tracking-[0.15em] text-sage">
              {typeLabel}
            </span>
            {!isSession && m.result && (
              <Badge
          ...
          {/* Sub info */}
          {sub && (
            <div className="text-xs text-sage mt-1">{sub}</div>
          )}
        </div>
    ...
    <main className="min-h-screen bg-black pb-24 px-4">
      ...
      <div>
        <div className="flex items-baseline justify-between mb-5">
          ...
          <Link
            href="/stats"
            className="text-[9px] text-sage hover:text-white transition-colors uppercase tracking-[0.2em]"
          >
            Tout voir →
          </Link>
        </div>
